    ...
    <div className="transform 
      ...
      >
          ...
          <div className="mb-4">
            ...
            {/* Reserve space for error/guideline */}
            <div className="h-[13px] mt-0.75">
              {errors.password ? (
              ...
              {[1, 2, 3, 4].map((i) => (
                <div
                  ...
                  className={`h-1 flex-1 rounded-full ${
                    form.password && strength && i <= strength.bars
                      ? strength.color
                      : "bg-gray-700"
                  }`}
                />
...
function Field({
  ...
  // Reserve vertical space for error/guideline (even if empty)
  const reservedSpace = "h-[13px] mt-0.75"; // adjust height as needed
