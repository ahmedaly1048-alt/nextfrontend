...
export default function ActivateWorkspacePage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#030711] px-4 sm:px-6">
      <div className="w-full max-w-md sm:max-w-[420px] md:max-w-[480px] rounded-2xl bg-[#030711] border border-[#1B2336] shadow-[0_0_40px_rgba(0,0,0,0.8)] p-5 sm:p-6 md:p-7 text-white relative">
        {/* Header */}
